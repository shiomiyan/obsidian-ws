...
export class WebContentSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		containerEl.createEl("p", {
			text: `Usage: Click the ribbon icon or run "Generate Week Digest" from the command palette. A dialog for entering the week number will appear when you execute it.`,
